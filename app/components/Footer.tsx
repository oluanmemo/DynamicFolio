...
export default function Footer() {
    ...
    const getFooterTagline = () => {
        if (mode === "dev") {
            return lang === "en"
                ? "Front-end development · Digital product · Available for freelance"
                : "Desenvolvimento front-end · Produto digital · Disponível para projetos";
        }
        return lang === "en"
            ? "Audiovisual · Editing · Digital Content"
            : "Audiovisual · Edição · Conteúdo Digital";
    };
